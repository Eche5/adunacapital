...
function Join() {
  return (
    <div className=" font-Montserrat text-center p-20">
      <h1 className=" text-customRed text-[40px] font-bold ">
        Invest with <span className=" text-customGrey">Aduna Capital.</span>
      </h1>
      <p>
        Take the leap into impactful investing with Aduna Capital. Align your
